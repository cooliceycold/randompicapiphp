...
if (file_exists(__DIR__ . '/xjj.txt')) // in the same folder
    $imgs_array = file(__DIR__ . '/xjj.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
else if (file_exists('../xjj.txt'))    // in the parent folder
    $imgs_array = file('../xjj.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
else                                   // for vercel runtime
    $imgs_array = file('http://' . $_SERVER['HTTP_HOST'] . '/xjj.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
